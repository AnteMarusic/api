...
int main() {
    ...
    while (fgets(input, MAX_LENGTH, stdin) != NULL) {
        ...
        if (strcmp(command, "aggiungi-stazione") == 0) {
            ...
            SHOW("posizione stazione da aggiungere: %d\n", posizione_stazione);
            ...
            token = strtok(NULL, " "); // prendo la posizione della stazione
            posizione_stazione = atoi(token);
            SHOW("posizione stazione da demolire: %d\n", posizione_stazione);
        ...
        //aggiungi-auto distanza-stazione autonomia-auto-da-aggiungere
            ...
            token = strtok(NULL, " "); // prendo la posizione della stazione
            posizione_stazione = atoi(token);
            SHOW("posizione stazione in cui inserire auto: %d\n", posizione_stazione);
            token = strtok(NULL, " "); // prendo la posizione della stazione
            gittata = atoi(token);
            SHOW("gittata macchina da inserire: %d\n", gittata);
        ...
        //rottama-auto distanza-stazione autonomia-auto-da-rottamare
            ...
            token = strtok(NULL, " "); // prendo la posizione della stazione
            posizione_stazione = atoi(token);
            SHOW("posizione stazione in cui rottamare auto: %d\n", posizione_stazione);
            token = strtok(NULL, " "); // prendo la posizione della stazione
            gittata = atoi(token);
            SHOW("gittata macchina da rottamare: %d\n", gittata);
            if (autostrada_contains(&autostrada, posizione_stazione)) {
